...
public class SQLCita {
	...
	{
		Query q = pm.newQuery(SQL, "SELECT CIUDADANO,FECHA, HORA_CITA,PUNTO_VACUNACION,VACUNA FROM " + pp.darTablaCita() + " WHERE PUNTO_VACUNACION = "+punto_vacunacion+"");
		System.out.println(punto_vacunacion);
